...
export default function RadialOrbitalTimeline({ timelineData }: RadialOrbitalTimelineProps) {
  ...
  return (
    <div
      className="w-full h-[620px] flex flex-col items-center justify-center overflow-hidden"
      ref={containerRef}
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Label */}
                <div className={`absolute top-12 whitespace-nowrap text-xs font-semibold tracking-wider transition-all duration-300 ${isExpanded ? "text-white" : "text-white/70"}`}>
                  {item.title}
                </div>
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-72 bg-black/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible">
                    ...
                    <CardHeader className="pb-2">
                      ...
                      <p className="text-[10px] text-indigo-400 uppercase tracking-widest">{item.category}</p>
                    </CardHeader>
                      ...
                      {item.relatedIds.length > 0 && (
                        <div className="mt-4 pt-3 border-t border-white/10">
                          <div className="flex items-center mb-2 gap-1">
                            ...
                            <h4 className="text-[10px] uppercase tracking-wider text-white/50">Connected Roles</h4>
                          </div>
